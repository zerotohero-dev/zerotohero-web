...
[taxonomies]
tags = ["spiffe", "spire", "kubernetes"]
+++

![Setting Up SPIRE on EKS in Less Than Ten Minutes](/images/size/w1200/2024/03/trust.png)

Trust is hard to gain, easy to lose. Zero Trust is no different. (generated by
Midjourney)
...
![SPIFEE and SPIRE Logos](/images/2021/10/spiffe-spire-logo-small.png)
...
![FizzBuzz Pro email verification flow.](/images/2021/10/Screen-Shot-2021-10-09-at-7.27.39-AM.png)
...
## "_Hope_" Is Not a Security Posture
...
![A subset of FizzBuzz Pro microservices' network boundaries.](/images/2021/10/network.png)
...
![A brand new "web UI" pod, reaching larger parts of the network than it should because it is inherently "trusted".](/images/2021/10/Screen-Shot-2021-10-09-at-8.11.10-AM.png)
...
dependency that it uses? How about _a dependency of a dependency of a
dependency... 🐢_? Can you be sure that the code is free of _logic errors_? Can
you be sure that the pod will not start acting weirdly all of a sudden?

![This is why code reviews are a good thing.](/images/2021/10/code-reviews.jpeg)
...
![The CIA triad.](/images/2021/10/cia-triad.png)
...
![SPIRE Server and Agent architecture.](/images/2021/10/server_and_agent.png)
...
![Turtles stacked up.](/images/2021/10/turtles.jpeg)
...
delegate the providing and rotating of the unseal key to a _bare metal_ or
_cloud_ **HSM**. But now, you'll need to protect the HSM's master key because
...
providing a valid identity, it will be "_public access,_" which defeats the
...
![A turtle in the bottom of the ocean (a "bottom turtle"?)](/images/2021/10/turtle-1.jpeg)
...
![No secrets, no problem.](/images/2021/10/Screen-Shot-2021-10-09-at-8.49.47-AM.png)
...
![There's no spoon.](/images/2021/10/no-spoon.jpeg)
